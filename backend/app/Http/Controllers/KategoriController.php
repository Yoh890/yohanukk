...
class KategoriController extends Controller
{
    ...
    public function store(Request $request)
    {
        $rules = [
            ...
            'fielddua' => 'required|string|max:258',
            'fieldtiga' => 'required|string|max:258',
        ];

        $messages = [
            'nama_kategori.required' => 'Nama kategori is required',
            'fielddua.required' => 'Field Dua is required',
            'fieldtiga.required' => 'Field Tiga is required',
        ];
        ...
        try {
            ...
            Kategori::create([
                ...
                'fielddua' => $request->input('fielddua'),
                'fieldtiga' => $request->input('fieldtiga'),
            ]);
